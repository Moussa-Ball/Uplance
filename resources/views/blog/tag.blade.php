...
<div id="titlebar" style="background: #F8F8F8; margin-bottom: 0;" class="gray">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>Blog</h2>
                <span>All posts of {{ strtolower($tag->name) }}</span>
                    ...
                    <form method="get" action="{{ route('blog.search') }}">
                        <div class="sidebar-widget margin-bottom-40">
                            <div class="input-with-icon">
                                <input style="box-shadow: 0 1px 4px 0 rgba(0,0,0,.12) !important;" class="custom-search-input" name="q" value="{{ old('q', Request::get('q')) }}" 
                                    id="autocomplete-input" type="text" placeholder="Search">
