...
<head>
    ...
    <title>{{ config('app.name', 'Uplance') }} - 404 Error</title>
			...
			<div class="col-xl-12">
				...
				<div class="row">
					<div class="col-xl-8 offset-xl-2">
							<div class="not-found-search margin-bottom-50">
								<!-- Button -->
								<div class="intro-search-button">
									<a href="{{ url('/') }}" style="margin: 0 auto;" class="button ripple-effect">Go Home</a>
								</div>
							</div>
					</div>
				</div>
